	...
	function send(){
		...
		for(var i=0; i<document.check.id.value.length; i++){ // 아이디 길이체크
			...
			if (!(ch >= '0' && ch <= '9') && !(ch >= 'a' && ch <= 'z')&&!(ch >= 'A' && ch <= 'Z')) { // 대소문자 및 숫자 입력가능
                ...
                document.check.id.select(); // document.엘리멘트.select로 해당 위치 드래그
                return false;
            }
		}
		// 아이디 유효성 검사 (공백) required사용
        ...
        // 비밀번호와 비밀번호 확인 일치여부 체크
         if (document.check.pw1.value != document.check.pw.value) {
            ...
            document.check.pw1.value = "" // 비밀번호가 다를때 비밀번호 확인칸 공백처리
							...
							<ul>
								...
								<li><a href="Categories.do">Categories <span
									...
									<ul class="dropdown">
										...
										<li><a href="Categories.do?mtype=멜로/로맨스">Melo/Romance</a></li>
										<!-- 컨트롤과 맞추기 -->
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="login__form">
						<h3>Sign Up</h3>
						<form action="Cinsert.do" method="post" class="check" name="check"
				...
				<div class="col-lg-6">
					<div class="login__social__links">
						<h3>이용약관</h3>
						<ul>
							<li><textarea readonly
									style="width: 400px; height: 100px; resize: none;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</textarea>
								<input type="checkbox" required form=check></li>
							<li><textarea readonly
									style="width: 400px; height: 100px; resize: none;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</textarea>
								<input type="checkbox" required form=check></li>
							<li><textarea readonly
									style="width: 400px; height: 100px; resize: none;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</textarea>
								<input type="checkbox" required form=check></li>
