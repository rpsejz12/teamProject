			...
			<div class="anime__details__content">
				...
				<c:choose>
						...
						<div class="row">
							<form class="col-lg-12" action="Mupdate.do?mpk=${datas.mpk}"
								...
								<div style="float:left;">
									<div class="product__item__pic set-bg"	data-setbg="${datas.filename}"></div>
								</div>
								<div class="col-lg-9 col-md-6 col-sm-6">
								

									<input type="file" name="filename" value="${datas.filename}" style="height:30px; width:400px; margin:12px; color:#ffffff; font-size:12px;">
									<br> <input type="text" name="title" value="${datas.title}" style="height:30px; width:400px; margin:12px"> <br> 
									...
									<h3>
										<input type="date" name="mdate" value="${datas.mdate}" style="height:30px; width:400px; margin:12px; font-size:12px">
									</h3>
					...
					<c:when test="${title == null || title == '' }">
						...
						<div class="row">
							<form class="col-lg-12" action="Minsert.do"
								method="post" name="insert" enctype="multipart/form-data">
								<div style="float:left;">
									<div class="product__item__pic set-bg"	data-setbg="${datas.filename}"></div>
								</div>
								<div class="col-lg-9 col-md-6 col-sm-6">
