                     ...
                     <div class="anime__details__title">
                        ...
                        <h3>${mdata.mtype}</h3>
                           ...
                           <c:if test="${mdata.ratingavg >= 2.5 && mdata.ratingavg < 3.5}">
                                   <p>&nbsp⭐⭐⭐</p><p style = "text-shadow: 0 0 0 #f0f0f0; color: transparent">⭐⭐</p>★★
                                 </c:if>
            ...
            <div class="col-lg-8">
               <div class="col-lg-12 col-md-12">
                  <div class="anime__details__form">
                     ...
                     <div class="section-title">
                        <h5 style="float: left;">Your Comment</h5>
                           <form action="Rinsert.do" method="post" name="review" id="myform" style=" user-select: none;">
                           ...
                           <label for="rate5">⭐</label>
                              ...
                              <textarea name="cmt" placeholder="Your Comment" required></textarea>
                               <br>
                        ...
                        <div class="anime__review__item">
                           <div class="anime__review__item__text">
                              <!-- 주석지우기 -->
                              <h6>${sessionID}
                                 - <span>${data.rdate}&nbsp</span>
                                 
                                 <c:if test="${data.rating== 1}">
                                 &nbsp★☆☆☆☆
                                 </c:if>
                                 
                                 <c:if test="${data.rating  == 2}">
                                 &nbsp★★☆☆☆
                                 </c:if>
                                 
                                 <c:if test="${data.rating  == 3}">
                                 &nbsp★★★☆☆
                                 </c:if>
                                 
                                 <c:if test="${data.rating  == 4}">
                                 &nbsp★★★★☆
                                 </c:if>
                                 
                                 <c:if test="${data.rating  == 5}">
                                 &nbsp★★★★★
                                 </c:if>
                        
                                 <button type="button" onclick="Rdelete()" style="color: #FFFFFF;background: #070720;outline: 0;border: 0;">Delete</button>
                              </h6>
                     ...
                     <c:forEach var="v" items="${datas}">
                        <div class="anime__review__item">
                           <div class="anime__review__item__text">
                              <!-- 주석지우기 -->
                              <h6>${v.id}
                                 - <span>${v.rdate}&nbsp</span>
                                 
                                 <c:if test="${v.rating== 1}">
                                 &nbsp★☆☆☆☆
                                 </c:if>
                                 
                                 <c:if test="${v.rating  == 2}">
                                 &nbsp★★☆☆☆
                                 </c:if>
                                 
                                 <c:if test="${v.rating  == 3}">
                                 &nbsp★★★☆☆
                                 </c:if>
                                 
                                 <c:if test="${v.rating  == 4}">
                                 &nbsp★★★★☆
                                 </c:if>
                                 
                                 <c:if test="${v.rating  == 5}">
                                 &nbsp★★★★★
                                 </c:if>
                              </h6>
